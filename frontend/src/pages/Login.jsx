...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
        ...
        {currentState === 'Sign Up' ? <input onChange={(e)=>setPhone(e.target.value)} value={phone} type="text" className='w-full px-3 py-2 border border-gray-800' placeholder='Phone' required/> : ''}
